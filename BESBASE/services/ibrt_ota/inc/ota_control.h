...
#define LOG_DBG(str,...)   TRACE(LOG_TAG""str, ##__VA_ARGS__)             // DEBUG OUTPUT
#define LOG_MSG(str,...)   TRACE(LOG_TAG""str, ##__VA_ARGS__)             // MESSAGE OUTPUT
#define LOG_ERR(str,...)   TRACE(LOG_TAG"err:"""str, ##__VA_ARGS__)       // ERROR OUTPUT
...
#else
#define LOG_DBG(str,...)
#define LOG_MSG(str,...)   TRACE(LOG_TAG""str, ##__VA_ARGS__)
#define LOG_ERR(str,...)   TRACE(LOG_TAG"err:"""str, ##__VA_ARGS__)
