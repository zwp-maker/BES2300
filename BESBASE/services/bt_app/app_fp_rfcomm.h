...
#define FP_MSG_DEVICE_INFO_ACTIVE_COMPONENTS_REQ    0x04
#define FP_MSG_DEVICE_INFO_ACTIVE_COMPONENTS_RSP    0x05
#define FP_MSG_DEVICE_INFO_TELL_CAPABILITIES        0x06
