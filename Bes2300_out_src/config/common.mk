...
ifneq ($(filter 1,$(BISTO) $(AMA_VOICE) $(DMA_VOICE)),)
BLE := 1
endif
...
ifeq ($(BLE),0)
KBUILD_CPPFLAGS += -DBESBT_STACK_SIZE=1024*4+512
else
...
ifeq ($(CHECK_TRACE_FORMAT),1)
KBUILD_CPPFLAGS	+= -DCHECK_TRACE_FORMAT
endif
...
export NV_EXTENSION_MIRROR_RAM_SIZE ?= 128
...
ifeq ($(TILE_DATAPATH_ENABLED),1)
#BLE := 1
KBUILD_CPPFLAGS += -DTILE_DATAPATH=1
else
KBUILD_CPPFLAGS += -DTILE_DATAPATH=0
endif
...
KBUILD_CPPFLAGS += -DCUSTOM_INFORMATION_TILE=0
endif # TILE
