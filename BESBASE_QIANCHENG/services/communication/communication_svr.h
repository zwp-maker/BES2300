...
enum SINGLE_CMD
{
	...
	FACTORY_GET_SOFT_VERSION	= 0x02,
	FACTORY_GET_BT_ADDRESS		= 0x06,
	FACTORY_SET_VOLUME			= 0x0B,
	FACTORY_CLAER_RECORD		= 0x0C,
	FACTORY_ENTER_PAIR			= 0x0D,
	FACTORY_SHUTDOWM_EAR		= 0x0E,
	FACTORY_ENTER_DUT			= 0x10,
	FACTORY_KEY_TEST			= 0x12,
	FACTORY_GET_BATTERY_VOLT	= 0x13,
	FACTORY_TWS_PAIR			= 0x17,
};
#endif
...
enum SINGLE_BOX_CMD
{
	OPEN_BOX			= 0x00,
	CLOSE_BOX			= 0x01,
	GET_BATTERY_VOLT	= 0x02,
	SHUTDOWM_EAR		= 0x03,
	GET_SOFT_VERSION	= 0x04,
};
